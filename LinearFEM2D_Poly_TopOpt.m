...
% Model = getLinearParameters2D('Michell','plane_str',5000 ,[1e5,0.3],0.5,3.0,0.1,[0.4,0.2],1000);
% Model = getLinearParameters2D('Serpentine','plane_str',5000,[1e5,0.3],0.5,3,0.4 ,[0.5,0.2],1000);
% Model = getLinearParameters2D('Suspension','plane_str',5000 ,[1e5,0.3],0.5,3,0.4 ,[0.5,0.2],1);
% Model = getLinearParameters2D('Wrench','plane_str',5000,[1e5,0.3],0.4,3,0.05,[0.5,0.2],1000);
Model = getLinearParameters2D('Hook','plane_str',5000,[1e5,0.3],0.5,2,0.05,[0.5,0.2],1000);
